                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                 src="{{ getResizedImage($product->image, \App\Daaruu\Constants\ImageSizeConstant::PRODUCT_540_560) }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        @else
                            <form action="{{ route('product.shop.add', encrypt($product->id)) }}" method="post">
                                ...
                                <button name="action" type="submit" class="primary-btn no-border" value="cart">ADD TO CART
                                </button>
                                <button name="action" type="submit" class="heart-icon no-border" value="wishList"><span
                        ...
                        <ul>
                            ...
                            <li><b>Category</b>
                                <span>{{ ($product->brand->category->parent ? ($product->brand->category->parent->name. ', ') : null) . ($product->brand->category->name ??  null)}}</span>
                            </li>
                            @if($product->country)
                                <li><b>Country</b> <span>{{ $product->country }}</span></li>
                            @endif
                            @if($product->country)
                            ...
                            <li><b>Share On</b>
                                <div class="share">
                                    <iframe
                                        src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Fdaaruu.com.np%2F&layout=button&size=large&width=77&height=28&appId"
                    ...
                    @foreach($relatedProducts as $product)
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{ getResizedImage($product->image, \App\Daaruu\Constants\ImageSizeConstant::PRODUCT_270_270) }}">
