...
@section('content')
    <div class="m-login__signin">
        <div class="m-login__head">
            <h3 class="m-login__title">Sign In To Staff</h3>
        </div>
        <form class="m-login__form m-form" method="post" action="{{ route('staff.auth.login') }}">
            @csrf
            ...
            <div class="row m-login__form-sub">
                ...
                <div class="col m--align-right">
                    <a href="{{ route('staff.auth.password.request') }}" class="m-link">Forget Password ?</a>
                </div>
            </div>
